...
#### 1-1-1 [SharpAI-LauncherTermux.apk](https://github.com/SharpAI/Hawkeye/releases/download/1.1/SharpAI-LauncherTermux.apk)
...
$PRIFIX/bin/wget https://github.com/SharpAI/Hawkeye/releases/download/1.1/usr_dev_root_armv7_1126_2018.tgz
...
$PRIFIX/bin/wget https://github.com/SharpAI/Hawkeye/releases/download/1.1/arch_dev_root_1203_2018_final.tgz
...
## 3 Start
```
$ cd /data/data/com.termux/files/home/Hawkeye
