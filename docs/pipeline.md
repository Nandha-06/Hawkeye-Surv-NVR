...
## Overview
The Hawkeye pipeline is a sophisticated system that processes video streams in real-time for various AI-powered detection and recognition tasks. This document explains the complete pipeline from video input to event notification.
