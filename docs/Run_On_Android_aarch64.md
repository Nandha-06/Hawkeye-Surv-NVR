...
|MediaTek MT6797|3GB|Mali-T880 MP4|Chuwi Hi9 Pro Tablet|Android 8.0.0|[TfLite Object Detection](https://github.com/SharpAI/Hawkeye/issues/19)|
|HiSilicon Kirin 970|4GB|Mali-G72 MP12 + NPU|Huawei Honor 10|Android 8.1.2|[TfLite Object Detection](https://github.com/SharpAI/Hawkeye/issues/19)|
...
wget https://github.com/SharpAI/Hawkeye/releases/download/1.1/usr_aarch64_dev_0318_2019.tgz
...
'1.3.1'
```
## Get the source code of Hawkeye
```
cd
git clone https://github.com/SharpAI/Hawkeye
cd Hawkeye
./setup.sh
cd build
./build_aarch64.sh ./
