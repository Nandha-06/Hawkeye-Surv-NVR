...
```
## Get Hawkeye Source Code

```
git clone https://github.com/SharpAI/Hawkeye -b pi
cd Hawkeye/docker
./run-deepeye-raspberrypi.sh start
```

Then follow the instruction on the [main readme](https://github.com/SharpAI/Hawkeye#how-to-run-hawkeye-from-source-code)
