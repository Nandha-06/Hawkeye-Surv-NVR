...
Registers RTSP camera streams with SharpAI Hawkeye's go2rtc sidecar for low-latency WebRTC live view in the browser.

## How It Works

```
Your Cameras (RTSP)          go2rtc (in Hawkeye)           Browser
───────────────────          ─────────────────           ───────
...
Hawkeye registers each stream with go2rtc via IPC:
